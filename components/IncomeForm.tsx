...
export const IncomeForm: React.FC<IncomeFormProps> = ({ income, onChange, onReplicate }) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
      <div className="bg-emerald-600 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={onReplicate}
            title="Copiar estes valores para todos os meses futuros"
            className="bg-emerald-700 hover:bg-emerald-800 text-emerald-100 text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-1 transition-colors"
          >
